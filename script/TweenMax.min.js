    ...
    _gsScope._gsDefine(
        ...
        function (a, b, c) {
            ...
            (f.version = "1.20.3"),
                ...
                (f.staggerFromTo = f.allFromTo = function (
                    a,
                    b,
                    c,
                    d,
                    ...
                    (d.exportRoot = function (a, b) {
                        ...
                        for (
                            null == b && (b = !0),
                                j._remove(i, !0),
                                i._startTime = 0,
                                i._rawPrevTime = i._time = i._totalTime =
                                    j._time,
                                g = j._first;
                            g;
        ...
        _gsScope._gsDefine(
            ...
            function (a, b) {
                ...
                var Aa,
                    ...
                    Ta = (S.set3DTransformRatio = S.setTransformRatio = function (
                        a
                    ) {
                        var b,
                            c,
                    ...
                    (this.check = function (j) {
                        ...
                        if (0 === s && g) {
                            if (
                                ...
                                (n = m.pop()),
                                (o = k(m.join("."))[n] = this.gsClass = g.apply(
                                    g,
                                    i
                                )),
                                h)
                    ...
                    for (g in this.vars)
                        if (((l = this.vars[g]), U[g]))
                            l &&
                                ...
                                (this.vars[g] = l = this._swapSelfInParams(
                                    l,
                                    this
                                ));
                        else if (
